...
package body resolution is
   ...
   begin
      -- determine la liste des valeurs à placer
      for col in  1 .. 9 loop
      ...
      -- affecte la liste des possibilités à placer à chaque case
      for col in  1 .. 9 loop
         ...
         for col in  1 .. 9 loop
            ...
            if sudoku(ligne)(col).valeur = 0 and nb_poss = 2 then
               ...
               restaure; --besoin de dupliquer et restaurer car evalue_possibilites
                         --peutavoir modifié les cas possibles des autres cases.
